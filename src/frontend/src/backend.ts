...
export class Backend implements backendInterface {
    ...
    async addPayment(arg0: string, arg1: number, arg2: string, arg3: string, arg4: string): Promise<Payment> {
        if (this.processError) {
            try {
    ...
    async createOrder(arg0: string, arg1: string, arg2: string, arg3: number): Promise<Order> {
        if (this.processError) {
            try {
    ...
    async getPartner(arg0: bigint): Promise<Partner> {
        if (this.processError) {
            try {
    ...
    async listTickets(): Promise<Array<Ticket>> {
        if (this.processError) {
            try {
                const result = await this.actor.listTickets();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async rejectPartner(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
    ...
    async submitPartner(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string): Promise<Partner> {
        if (this.processError) {
            try {
                const result = await this.actor.submitPartner(arg0, arg1, arg2, arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
